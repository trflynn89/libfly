...
TEST(ParserExceptionTest, ParserExceptionTest)
{
    ...
    try
    {
        throw fly::ParserException(file, line, column, message);
    }
    catch (const fly::ParserException &ex)
    {
        std::string what(ex.what());
...
TEST(ParserExceptionTest, UnexpectedCharacterException)
{
    ...
    try
    {
        throw fly::UnexpectedCharacterException(file, line, column, c1);
    }
    ...
    try
    {
        throw fly::UnexpectedCharacterException(file, line, column, c2);
    }
    catch (const fly::UnexpectedCharacterException &ex)
    {
        std::string what(ex.what());
...
TEST(ParserExceptionTest, BadConversionException)
{
    ...
    try
    {
        throw fly::BadConversionException(file, line, column, value);
    }
