...
"%msbuild%" %root_dir%\libfly.vcxproj /m /t:Rebuild /p:Configuration=Release /p:Platform=x64
if %errorlevel% GEQ 1 echo error: Failed release x64 build & goto :eof

"%msbuild%" %root_dir%\libfly.vcxproj /m /t:Rebuild /p:Configuration=Release /p:Platform=x86
