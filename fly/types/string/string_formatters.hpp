...
template <detail::IsFormatUserDefined T, typename CharType>
struct Formatter<T, CharType>
{
    /**
     ...
     */
    template <typename FormatContext>
    inline void format(const T &value, FormatContext &context)
    {
...
template <detail::IsLikeSupportedString T, typename CharType>
struct Formatter<T, CharType>
{
    /**
...
template <detail::IsFormatPointer T, typename CharType>
struct Formatter<T, CharType>
{
    /**
...
template <detail::IsFormatIntegral T, typename CharType>
struct Formatter<T, CharType>
{
    /**
...
private:
     ...
     */
    template <typename U>
    static inline std::size_t count_digits(U value, int base)
    {
        std::size_t digits = 0;
...
template <detail::IsFormatFloat T, typename CharType>
struct Formatter<T, CharType>
{
    /**
...
template <detail::IsFormatBoolean T, typename CharType>
struct Formatter<T, CharType>
{
    /**
